function AppHeader() {
  return (
    <div className="fixed top-0 right-0 left-[270px] w-[calc(100% - 270px)] h-20 border-b border-[#DBDBDB] bg-[#FFFFFF]">
      <div className="container mx-auto px-12 flex items-center h-full">
        <div className="flex items-center gap-4 px-4 py-3 bg-[#F5F5F5] w-96 rounded-md">
          <svg
            width="23"
            height="22"
            viewBox="0 0 23 22"
          ...
          <input
            className="bg-inherit outline-none flex-1 placeholder:text-[#787486]"
        ...
        <div className="flex items-center ml-12">
          ...
          <img
            className="w-10 h-10 rounded-full ml-6 mr-2"
            src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
            alt="authUserProfilePicPng"
          />
          <svg
            width="18"
            height="18"
