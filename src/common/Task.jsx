  ...
  return (
    <div className="bg-[#FFFFFF] p-6 rounded-2xl">
      <div className="flex items-center justify-between">
        <div
          className={clsx(
            "rounded-md py-1 px-2 text-sm mb-1",
            {
      ...
      <div className="flex items-center gap-4">
        <div className="flex -space-x-1 overflow-hidden">
          ...
          {collaborators?.length - collaboratorsToShow?.length > 0 ? (
            <div className="inline-flex items-center justify-center h-5 w-5 rounded-full ring-1 ring-white bg-[#F4D7DA] text-[#D25B68] text-xs font-medium">
              +{collaborators?.length - collaboratorsToShow?.length}
            </div>
          ) : null}
        </div>
        ...
        {[
          ...
          <div key={title} className="flex items-center gap-x-1 text-sm">
            {icon} <span>{count}</span> <span>{title}</span>
          </div>
        ))}
      </div>
    </div>
